...
(function() {
  var ALWAYS_TRUE, REGISTERED_TYPES, THROW_IT, UNDEF, checkValidations, fTake, passesValidators, pfunk, r, _,
    __slice = [].slice;
  ...
  pfunk = function(base_fn, failure, base_checks) {
    if (failure == null) {
      failure = (function(e) {
        return e;
      });
    ...
    base_fn.withSignature = function() {
      ...
      _fn = function(v, i) {
        if (_.isString(v) && (REGISTERED_TYPES[v] != null)) {
  ...
  pfunk.strong = function(base_fn, base_checks) {
    if (base_checks == null) {
      base_checks = {};
    }
    return pfunk(base_fn, THROW_IT, base_checks);
  };

  pfunk.loose = function(base_fn, base_checks) {
    if (base_checks == null) {
      base_checks = {};
    }
    return pfunk(base_fn, UNDEF, base_checks);
  };

  pfunk.registerType = function(type_name, fn) {
    return REGISTERED_TYPES[type_name] = fn;
  };
